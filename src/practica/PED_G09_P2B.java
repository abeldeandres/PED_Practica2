...
public class PED_G09_P2B {
    ...
    public static <E extends Comparable<E>> void invertirCola(LECola<E> cola)
    {
        if(!cola.esVacia())
        {
    ...
    public static <E extends Comparable<E>> int contarElementosIterativo(LECola<E> cola)
    {
        if(!cola.esVacia()){
    ...
    public static <E extends Comparable<E>> int contarElementosCola(LECola<E> cola)
    {
    ...
    public static <E extends Comparable<E>> int contarElementosColaRec(LECola<E> cola)
    {
        int contador=0;
        if(cola.esVacia())
        {
    ...
    public static <E extends Comparable<E>> void insercionEspecial(LECola<E> cola, E elemento)
    {
    ...
    //el resultado pedido.
    public static <E extends Comparable<E>> void insercionEspecialRec(LECola<E> cola, E elemento, boolean encontrado)
    {
        if(!cola.esVacia()){
            if(!encontrado)
            {
                    ...
                    if (!colaCreada) {
                        ...
                        do {
                            ...
                            if (numero == -1) {
                                ...
                                LECola.encolar(new Integer(numero));
                            }
                        ...
                        if (LECola.esVacia()) {
                            ...
                            System.out.println(LECola.toString());
                ...
                case 4:
                    ...
                    if (!colaConContenido) {
                        ...
                        if (!LECola.esVacia()) {
                            ...
                            System.out.println(LECola.toString());
                            int numElementos=contarElementosIterativo(LECola);
                ...
                case 5:
                    ...
                    if (!colaConContenido) {
                        ...
                        if (!LECola.esVacia()) {
                            System.out.println("\nEstado inicial de la cola: \n");
                            System.out.println(LECola.toString());
                            int numElementos=contarElementosCola(LECola);
                            System.out.println("El numero de elementos que se encuentra en la cola es: \n"+numElementos);
                        } else {
                            System.out.println("\nLo sentimos, la Cola está vacía, por favor, rellenela de elementos previamente (Opción 2 del menú).\n");
                        }
                ...
                case 6:
                    ...
                    if (!colaConContenido) {
                        ...
                        if (!LECola.esVacia()) {
                            ...
                            int entero = leerInt();
                            insercionEspecial(LECola, entero);
